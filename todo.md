...
- [ ] Разнести подписки на события в отдельные классы
- [ ] Разнести логику обработки событий в отдельные классы
- [ ] Сделать систему модульной, как система плагинов на серверах Spigot в Minecraft

## 11. Инстансы и переходы между мирами

- [x] Реализовать Gateway/Proxy
- [x] Добавить событие C2S_SWITCH_WORLD
- [x] Graceful disconnect
- [x] Написать тест на переключение
...
- [x] Добавлены пакеты для контента (combat, inventory, effects, audio)
## Исправления
